package com.info.test.springboot.config;
...
import com.info.test.springboot.filter.JwtRequestFilter;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private MyUserDetailsService userSeviceDetails;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(userSeviceDetails);
	}
